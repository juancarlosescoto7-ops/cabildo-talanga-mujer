...
export const officeWomanReport = {
  ...
  axes: [
    ...
    },
    {
      ...
      representative: {
        label: "Representante",
        testimonyBackground: "/images/cabildo-mujer/testimonios/fondos/prevencion-vanessa-martinez-v2.png",
        names: ["Licenciada Vanessa Martínez"],
        role: "Facilitadora de prevención",
        story: "Acompañó las charlas contra la violencia doméstica, acercando información y orientación a las participantes.",
      },
      activities: [
    ...
    },
    {
      ...
      representative: {
        label: "Beneficiaria",
        testimonyBackground: "/images/cabildo-mujer/testimonios/fondos/salud-claudia-leticia-barahona-v2.png",
        names: ["Claudia Leticia Barahona"],
        role: "Apoyo con medicamentos",
        story: "Estuvo a punto de perder una pierna. La donación de medicamentos fue decisiva para su tratamiento y le permitió recuperarse.",
      },
      activities: [
    ...
    },
    {
      ...
      representative: {
        label: "Beneficiaria",
        testimonyBackground: "/images/cabildo-mujer/testimonios/fondos/ambiente-martha-maribel-lopez-v2.png",
        names: ["Martha Maribel López"],
        role: "Trabajo temporal en áreas verdes",
        story: "Recibió apoyo mediante trabajo temporal en el mantenimiento de áreas verdes, abriendo espacio para incluir a más mujeres en este campo.",
      },
      activities: [
